"""Integration: ProfileIndexer + OllamaJudge against real services.

Requires:
  - Ollama running on localhost:11434
  - Available models: nomic-embed-text (embeddings), deepseek-r1:14b (judge)
  - LanceDB in data/test_lancedb_judge/
...
def test_judge_profile_fragments_retrieved(indexed_store):
  """The store retrieves relevant profile fragments for the offer."""
